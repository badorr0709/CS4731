...
vshader1.glsl
  This shader implements flat shading, and passes vertex information along to the
  fragment shader.

fshader1.glsl
  This shader either outputs a color supplied by the vertex shader (if a boolean
  uniform flag is set to true) or implements smooth (phong) shading.
