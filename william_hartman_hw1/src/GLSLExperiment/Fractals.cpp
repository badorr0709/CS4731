...
void makeFern(point2 points[], int iters, float x, float y) {
	static float a[] =  { 0.00f,  0.20f, -0.15f,  0.85f};
	static float b[] =  { 0.00f,  0.23f,  0.26f, -0.04f};
	static float c[] =  { 0.00f, -0.26f,  0.28f,  0.04f};
	static float d[] =  { 0.16f,  0.22f,  0.24f,  0.85f};
	static float tx[] = { 0.00f,  0.20f,  0.00f,  0.00f};
	static float ty[] = { 0.00f,  1.60f,  0.44f,  1.60f};
